...
function displayPics(){
  ...
  // console.log(rando); //<---- This line is throwing errors and needs to be deleted
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
  // Because the variable rando is outside of scope from on Line 33, once that variable is assigned within the first while loop. that variable can be used within that loop and not outside of it.
  console.log(viewed);
